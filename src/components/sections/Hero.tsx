...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-[#001a3f]">
      {/* Background Elements */}
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 xl:col-span-8">
            ...
            >
              <Link
                href="/contact"
                className="px-8 py-4 bg-accent text-[#001a3f] font-extrabold rounded-xl hover:bg-white hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex items-center gap-2"
              >
                Get Free Consultation <ArrowRight className="w-5 h-5" />
              </Link>
              <Link
                href="/services"
                className="px-8 py-4 bg-white/10 text-white font-extrabold rounded-xl border border-white/20 hover:bg-white/20 hover:-translate-y-1 transition-all duration-300 flex items-center gap-2 backdrop-blur-sm"
              >
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center gap-6 text-white/60 text-xs font-bold uppercase tracking-wider"
            >
