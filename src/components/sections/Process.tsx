      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl lg:text-5xl font-black text-dark mb-6 leading-tight">
            Streamlined <span className="text-primary">Execution</span> <br />
            Process
          </h2>
          <p className="text-base lg:text-lg text-text-secondary leading-relaxed">
            Our established methodology ensures your business setup in Qatar is
          ...
          <div className="relative mt-16 lg:mt-24">
            ...
            <div className="md:hidden absolute top-6 bottom-6 left-6 w-px border-l-2 border-dashed border-primary/20 z-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8">
              {processSteps.map((step, index) => (
                ...
                >
                  ...
                  <div className="mt-1 md:mt-8 flex-1">
