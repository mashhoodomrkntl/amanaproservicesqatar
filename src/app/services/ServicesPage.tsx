...
export default function ServicesPage() {
  ...
  return (
    <div className="bg-[#FAFAFA]">
      <PageHeader
        title="Our Expertise"
        subtitle="End-to-end business solutions engineered for success in Qatar's dynamic market."
                  ...
                  >
                    ...
                    <div className="p-8 pt-12 flex flex-col h-full relative z-10">
                      ...
                      <div className="mt-auto flex items-center gap-2 text-[#0A2647] text-[10px] font-black uppercase tracking-[0.2em]">
                        ...
                        <ArrowRight className="w-4 h-4 transition-transform duration-500 group-hover:translate-x-2 text-accent" />
                      </div>
                    </div>
